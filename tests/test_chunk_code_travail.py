...
def test_infer_theme_uses_article_ranges() -> None:
    ...
    assert infer_theme("L1221-10-1") == "contrat de travail"
    assert infer_theme("L1221-19") == "rupture de la periode d'essai"
    assert infer_theme("L1221-19-1") == "rupture de la periode d'essai"
    ...
    assert infer_theme("L1237-11-1") == "rupture conventionnelle"
